...
def valid_zip(tmpdir):
    ...
    zip_file_path = tmpdir / "test.zip"
    file_inside_zip = tmpdir / "test.txt"
    ...
    return Path(zip_file_path), Path(tmpdir)
