...
async def update_async() -> bool:
    ...
    with tempfile.TemporaryDirectory() as download_temp, tempfile.TemporaryDirectory() as zip_temp:
        ...
        try:
            await download_file_async(UPDATE_URL_DOWNLOAD_SCRUTINS,
                                      zip_file_scrutins)
            await download_file_async(UPDATE_URL_DOWNLOAD_ACTEUR_ORGANE,
...
async def start_planning(bot, upload_at_launch: bool) -> None:
    """
